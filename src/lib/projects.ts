...
export const projects: Project[] = [
  {
    name: "NutriXtract",
    description:
      "Our Thesis project regarding Nutritions, presented in AAIML Japan 2026",
  ...
  },
  {
    ...
    description:
      "User-centric tool aiding users in Job Applications, tracker and CL generator all in one.",
  ...
  },
  {
    name: "CafeMo",
    description:
      "Intelligent Systems course final project requirement, an AI-powered cafe kiosk",
